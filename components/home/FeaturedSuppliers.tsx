      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-6 md:gap-8">
              ...
              <div className="relative p-4 sm:p-6 md:p-8">
                ...
                <div className="hidden md:flex justify-center items-center gap-4 flex-wrap">
                  {sellers?.map((seller, index) => (
                    <div
                      ...
                      style={{ animationDelay: `${index * 0.1}s` }}
                    >
                      <div className="bg-white rounded-xl p-3 shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 border border-primary-500/20 flex items-center justify-center min-w-[70px] min-h-[70px] max-w-[90px] max-h-[90px]">
                        <SellerLogoContainer seller={seller} />
                      </div>
                    </div>
                  )).slice(0, 8)}
                ...
                <div className="mt-8 text-center">
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full">
                    <button className="w-full sm:w-auto inline-flex items-center gap-3 px-6 py-4 bg-primary-500 text-white rounded-full hover:bg-primary-600 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 font-semibold justify-center">
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto inline-flex items-center gap-3 px-6 py-4 bg-white border-2 border-primary-500 text-primary-500 rounded-full hover:bg-primary-50 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105 font-semibold justify-center"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="none"
          ...
          <div className="w-full max-w-5xl mt-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 bg-gradient-to-r from-white via-primary-50/30 to-white rounded-2xl p-4 sm:p-6 border border-primary-500/20 shadow-sm">
              <div className="text-center group flex flex-col items-center">
                <div className="relative inline-flex items-center justify-center w-16 h-16 bg-primary-50 rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300">
