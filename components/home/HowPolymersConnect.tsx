  ...
  return (
    <div className="mt-12 md:mt-16 mb-8 md:mb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
        {/* For Buyers Section */}
        <div className="bg-primary-50 rounded-2xl p-6 md:p-8 border border-primary-500/20">
          ...
          <div className="mt-6 p-4 bg-primary-50 rounded-xl border border-primary-500/30">
            <p className="text-primary-600 text-sm font-medium text-center">
