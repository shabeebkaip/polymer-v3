  ...
  return (
    <div className="relative w-full group">
      ...
      <input
        ...
        className="w-full pl-12 pr-16 py-4 rounded-xl border border-gray-300 bg-white/80 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-300 hover:border-gray-400 placeholder-gray-500 text-gray-900 shadow-sm hover:shadow-md focus:shadow-lg"
        value={query?.search || ""}
        onChange={(e) => onSearch?.(e.target.value)}
      />
      
      <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
        <div className="w-10 h-10 bg-primary-500 hover:bg-primary-600 rounded-lg flex justify-center items-center shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer group">
