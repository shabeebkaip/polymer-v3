  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_25%_25%,_rgba(19,111,71,0.3)_0%,_transparent_50%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_75%_75%,_rgba(19,111,71,0.3)_0%,_transparent_50%)]"></div>
            ...
            <div className="flex justify-center lg:justify-start gap-4">
              {socials.map((social) => (
                <a
                  ...
                  className="w-10 h-10 bg-gray-800 hover:bg-primary-500 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 group"
                >
                  <Image
                    src={social.icon}
                    alt={social.label}
              ...
              {[
                ...
                <li key={link.label}>
                  <button
                    ...
                    className="text-gray-300 hover:text-primary-500 transition-all duration-200 hover:translate-x-1 text-sm font-medium group flex items-center gap-2"
                  >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <span className="text-primary-500 text-xs font-medium">Trusted Platform</span>
              </div>
            </div>
            
            <div className="flex items-center gap-6">
              <button className="text-gray-400 hover:text-primary-500 text-sm transition-colors duration-200">
                Privacy Policy
              </button>
              <button className="text-gray-400 hover:text-primary-500 text-sm transition-colors duration-200">
                Terms of Service
