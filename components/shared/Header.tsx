            ...
            <div className="relative" ref={languagePopupRef}>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-700">
                  {language === "en" ? "English" : language === "ar" ? "العربية" : language === "de" ? "Deutsch" : "中文"}
                </span>
              ...
              <PopoverContent className="w-64 p-0 bg-white border-0 shadow-xl rounded-xl overflow-hidden">
                ...
                <div className="p-2">
                  {[
                    ...
                    { href: "/user/sample-requests", label: "Sample Requests", icon: "📋" },
            ...
            <div className="flex-1 p-6 space-y-2">
              ...
              <div className="pt-4">
                ...
                >
                  ...
                  <svg className={`w-4 h-4 transition-transform duration-200 ${isVisible ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
