...
import type { DealQuoteComment, CommentAttachment } from '@/types/comment';
...
export const CommentSection: React.FC<CommentSectionProps> = ({
  ...
  const [comments, setComments] = useState<DealQuoteComment[]>([]);
  ...
  const handleAddComment = async (
    ...
    try {
      await commentService.addComment(dealQuoteRequestId, {
        comment,
