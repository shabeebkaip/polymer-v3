...
import { Shield, Award, CheckCircle2, Star, Crown, Zap, Lock, Plus, Trash2, GripVertical, FileText, Calendar } from "lucide-react";
    ...
    <>
      <div className="col-span-full mb-4">
        <div className="flex items-center justify-between pb-3 border-b border-gray-200">
          <div>
            ...
            <p className="text-xs text-gray-600 mt-0.5">Showcase regulatory compliance and industry standards</p>
          </div>
      ...
      <div className="col-span-full space-y-3">
        {CERTIFICATIONS.map((cert) => {
          ...
          const certificateFieldKey = cert.key === 'fdaApproved' ? 'fdaCertificate' : 'medicalCertificate';
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-start justify-between gap-3 mb-2">
                      ...
                      <Badge variant="outline" className="bg-amber-50 border-amber-200 text-amber-700 text-xs px-2 py-0 flex-shrink-0">
                        Premium
                      </Badge>
                    </div>
                        ...
                        <div className="flex items-start gap-3">
                          <div className="flex-1">
                            ...
                            <FileUpload
                              ...
                              existingFiles={hasCertificate && certificateData.id ? [certificateData as any] : []}
                              multiple={false}
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-200">
              <div>
                ...
                <p className="text-xs text-gray-600 mt-0.5">Add custom ISO, quality, or industry-specific certifications</p>
              </div>
              <Badge variant="outline" className="bg-gray-100 text-gray-700 border-gray-300 text-xs">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1 space-y-3">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div>
                              <Label htmlFor={`cert-name-${index}`} className="text-xs font-medium text-gray-700">
                            ...
                            <div>
                              ...
                              <FileUpload
                                onFileUpload={(files) => updateCertificate(index, "document", files[0])}
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                            <div>
                              <Label htmlFor={`cert-authority-${index}`} className="text-xs font-medium text-gray-700">
                            ...
                            <div>
                              <Label htmlFor={`cert-number-${index}`} className="text-xs font-medium text-gray-700">
                            ...
                            <div>
                              <Label htmlFor={`cert-issue-${index}`} className="text-xs font-medium text-gray-700">
                            ...
                            <div>
                              <Label htmlFor={`cert-expiry-${index}`} className="text-xs font-medium text-gray-700">
                          ...
                          <div>
                            <Label htmlFor={`cert-desc-${index}`} className="text-xs font-medium text-gray-700">
