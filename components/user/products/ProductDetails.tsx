  ...
  return (
    <>
      {fieldGroup === 'required' && (
        <>
          {/* Chemical Family */}
          <div className={`space-y-1.5${aiWrapCls('chemicalFamily')}`} id="chemicalFamily-field" tabIndex={-1}>
          ...
          <div className={`space-y-1.5${aiWrapCls('polymerTypes')}`} id="polymerType-field" tabIndex={-1}>
            <div className="flex items-center gap-1.5">
              <Label className="text-xs font-medium text-gray-700 flex items-center gap-1">
                Polymer Type
                <span className="text-red-500">*</span>
          ...
          {/* Physical Form */}
          <div className={`space-y-1.5${aiWrapCls('physicalForm')}`} id="physicalForm-field" tabIndex={-1}>
            <div className="flex items-center gap-1.5">
              <Label className="text-xs font-medium text-gray-700 flex items-center gap-1">
                Physical Form
                <span className="text-red-500">*</span>
          ...
          {/* Industries */}
          <div className={`space-y-1.5${aiWrapCls('industry')}`} id="industry-field" tabIndex={-1}>
            <div className="flex items-center gap-1.5">
              <Label className="text-xs font-medium text-gray-700 flex items-center gap-1">
                Industries
                <span className="text-red-500">*</span>
